...
$item=pdo_get('lhyzhnc_sun_withdrawset',array('uniacid'=>$_W['uniacid']));
...
if(checksubmit('submit')){
    ...
    if($_GPC['id']==''){
        ...
        $res=pdo_insert('lhyzhnc_sun_withdrawset',$data);
        if($res){
        ...
        $res = pdo_update('lhyzhnc_sun_withdrawset', $data, array('id' => $_GPC['id']));
        if($res){
