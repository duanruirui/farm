...
<style>
	...
	.fa-database,.fa-map-marker,.fa-book,.fa-bars,.fa-info-circle,.fa-cart-plus,.fa-desktop,.fa-product-hunt,.fa-life-ring,.fa-bars,.fa-recycle,.fa-cog,.fa-gift,.fa-binoculars,.fa-trophy,.fa-key,.fa-bank,.fa-bullseye{margin-right: 14px;}
...
<style type="text/css">
    .footer{position: fixed;bottom: 0px; right: 0px;width: 100%;}
    .yg_back{margin-bottom: 50px;}
</style>
