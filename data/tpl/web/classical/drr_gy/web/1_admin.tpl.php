...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl('admin')?>">管理人员列表</a></li>
    <li><a href="<?php  echo $this->createWebUrl('admin',array('op'=>'add'))?>">添加管理人员</a></li>
</ul>
<div class="main">
                ...
                <div class="row">
                    <table class="yg5_tabel col-md-12">
                        ...
                        <tr class="yg5_tr2">
                            ...
                            <td>
                                <a href="<?php  echo $this->createWebUrl('admin', array('op' => 'edit','id' => $row['id']))?>" class="storespan btn btn-xs">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?php  echo $this->createWebUrl('admin', array('op' => 'delete','id' => $row['id']))?>" type="button" class="btn btn-info" >确定</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
