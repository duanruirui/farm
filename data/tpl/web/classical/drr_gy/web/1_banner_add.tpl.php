...
<ul class="nav nav-tabs">
    ...
    <li><a href="<?php  echo $this->createWebUrl('banner')?>">轮播图管理</a></li>
    <li class="active"><a href="<?php  echo $this->createWebUrl('banner',array('op'=>'add'))?>">添加轮播图</a></li>
</ul>
<div class="main">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block" id="">*建议比例 750*340</span>
                    </div>
                </div>
                <div class="form-group">
